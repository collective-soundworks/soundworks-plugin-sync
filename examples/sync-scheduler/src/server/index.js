...
import syncServiceFactory from '@soundworks/service-sync/server';
...
(async function launch() {
  try {
    ...
    // keep default `getTimeFunction`, as in most of the cases
    server.registerService('platform', platformServiceFactory, {}, []);
    server.registerService('sync', syncServiceFactory, {}, []);
